...
export const PlayerRecordSchema = z.object({
  ...
  career_seasons: z.array(z.object({
    ...
    gf_5v5:      z.number().int().optional(),
    ga_5v5:      z.number().int().optional(),
    xgf_5v5:     z.number().optional(),
    xga_5v5:     z.number().optional(),
...
export const GoalieRecordSchema = z.object({
  ...
  game_type:   z.number().int().optional().default(2),
  gp:          z.number().int().nonnegative().nullable().optional(),
  toi_sec:     z.number().nonnegative().nullable().optional(),
  sa:    z.number().int().nonnegative(),
  saves: z.number().int().nonnegative().optional(),
  ga:    z.number().int().nonnegative(),
  xga:   z.number(),
  gsax:  z.number(),
  gsax_per60:   z.number().nullable().optional(),
  gsax_per_100: z.number().nullable().optional(),
  sv_pct:  z.number().nullable(),
  xsv_pct: z.number().nullable().optional(),
  dsv_pct: z.number().nullable().optional(),
  gaa:     z.number().nullable().optional(),
  sa_5v5:      z.number().int().nonnegative(),
  ga_5v5:      z.number().int().nonnegative(),
  sog_5v5:     z.number().int().nonnegative().nullable().optional(),
  xga_5v5:     z.number().nullable().optional(),
  gsax_5v5:    z.number().nullable().optional(),
  sv_pct_5v5:  z.number().nullable().optional(),
  toi_5v5_sec: z.number().int().nonnegative().nullable().optional(),
  sc_against:  z.number().int().nonnegative().optional().default(0),
  hdc_against: z.number().int().nonnegative().optional().default(0),
  hdg_allowed: z.number().int().nonnegative().optional().default(0),
  hd_sv_pct:   z.number().nullable().optional(),
  ...
  playoff_toi_sec:     z.number().int().nonnegative().nullable().optional(),
  playoff_gsax_per60:  z.number().nullable().optional(),
  playoff_sv_pct:      z.number().nullable().optional(),
  playoff_xsv_pct:     z.number().nullable().optional(),
  playoff_dsv_pct:     z.number().nullable().optional(),
  playoff_gaa:         z.number().nullable().optional(),
  playoff_xga:         z.number().nullable().optional(),
  playoff_sa_5v5:      z.number().int().nonnegative().nullable().optional(),
  playoff_ga_5v5:      z.number().int().nonnegative().nullable().optional(),
  playoff_sog_5v5:     z.number().int().nonnegative().nullable().optional(),
  playoff_xga_5v5:     z.number().nullable().optional(),
  playoff_gsax_5v5:    z.number().nullable().optional(),
  playoff_sv_pct_5v5:  z.number().nullable().optional(),
  playoff_toi_5v5_sec: z.number().int().nonnegative().nullable().optional(),
  ...
  career_seasons: z.array(z.object({
    ...
    team_abbrev:   z.string().nullable().optional(),
    gp:            z.number().int(),
    sa:            z.number().int(),
    ga:            z.number().int(),
    sv_pct:        z.number().nullable(),
